...
public class Main {
    public static void main(String[] args) {
        ...
        Teacher addOne = new Teacher("Furkan Hoca", "12345-1245-44", "Maths Teacher");
        Teacher addTwo = new Teacher("Furkan Hoca2", "44124-44-15", "Physc Teacher");
        Teacher addThree = new Teacher("Furkan Hoca3", "4124-55-123", "Chemic Teacher");
